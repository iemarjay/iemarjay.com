export function GmailIcon() {
  return <svg xmlns="http://www.w3.org/2000/svg" width="32" height="33" viewBox="0 0 32 33" fill="none">
    <g id="gmail" filter="url(#filter0_d_10_379)">
      <path id="bg"
      ...
      <g id="gmail_2">
        ...
        <path id="Vector_3"
              ...
              fill="#34A853"/>
        <path id="Vector_4" d="M9.94787 23.9999V15.0731L9.94019 15.0668L9.94787 23.9999Z" fill="#C5221F"/>
        <path id="Vector_5"
              d="M9.94014 8.52429L8.37646 7.39407C5.60179 5.91026 5 9.17716 5 9.17716V11.4654L9.94014 15.0669V8.52429Z"
              fill="#C5221F"/>
        <path id="Vector_6" d="M9.94019 8.52417V15.0668L9.94787 15.0731V8.53048L9.94019 8.52417Z" fill="#C5221F"/>
        <path id="Vector_7"
    ...
    <defs>
      <filter id="filter0_d_10_379" x="-2" y="-1" width="36" height="36" filterUnits="userSpaceOnUse">
